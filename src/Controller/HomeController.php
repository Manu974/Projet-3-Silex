...
class HomeController {
    ...
    */
    public function indexAction(Application $app) {
        ...
        return $app['twig']->render('index.html.twig', ['billets' => $billets]);
    }

    /**
    * Billet details controller.
    *
    * @param integer $id Billetd
    ...
    public function billetAction($billet_id, Request $request, Application $app) {
        ...
        if ($app['security.authorization_checker']->isGranted('IS_AUTHENTICATED_FULLY')) {
            ...
            if ($commentForm->isSubmitted() && $commentForm->isValid()) {
                ...
                return $app->redirect($app['url_generator']->generate('billet', ['billet_id'=> $billet_id]
                ));
            }
        ...
        return $app['twig']->render('billet.html.twig', [
            'billet' => $billet, 
            'comments' => $comments,
    ...
    */
    ...
    public function replyAction($comment_id,$billet_id, Request $request, Application $app) {
        ...
        return $app['twig']->render('comment_reply.html.twig', [
            'billet' => $billet, 
            'comments' => $comments,
            'comment' => $comment,
